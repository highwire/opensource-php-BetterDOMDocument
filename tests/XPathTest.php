...
class XPathTest extends \PHPUnit_Framework_TestCase {
    ...
    private $hwsearch_xml = '<?xml version="1.0" encoding="UTF-8"?>
    ...
    public function testPrefixAttr() {
